...
=======
    ...
    users: [1, 2, 5],
    messages: [1, 2, 3, 4],
>>>>>>> 737a6af9402e5c844d7d4371d408bd44c060f60a
  },
  {
    tripId: 2,
    ownerId: 2,
...
Message.insertMany(dummyMessages).then((response) => {
  console.log('Inserted messages');
});

Profile.insertMany(dummyProfiles).then((response) => {
  console.log('Inserted profiles');
});

Trip.insertMany(dummyTrips).then((response) => {
